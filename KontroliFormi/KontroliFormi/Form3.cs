...
namespace KontroliFormi
{
    public partial class Admin : Form
    {
        ...
        private void btnAdding_Click(object sender, EventArgs e)
        {
            ...
            daza11DataSet.Tablica.AddTablicaRow(txtNaming.Text,txtBoxArtist.Text,txtProducing.Text,int.Parse(txtDating.Text),int.Parse(txtGifting.Text),txtBoxNameSong.Text);
        }
